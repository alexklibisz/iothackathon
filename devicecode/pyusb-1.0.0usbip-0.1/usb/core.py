...
class Device(object):
    ...
    def write(self, endpoint, data, interface = None, timeout = None, submit = True, complete = True):
        r"""Write data to the endpoint.
	...
	submit and complete provide control over USB split transactions.  To initiate pipelined writes, set complete=False.  To drain the pipeline, set submit=False.
    ...
    def read(self, endpoint, size, interface = None, timeout = None, submit = True, complete = True):
        r"""Read data from the endpoint.
	...
	submit and complete provide control over USB split transactions.  To initiate pipelined reads, set complete=False.  To drain the pipeline, set submit=False.
...
def find(find_all=False, backend = None, custom_match = None, **args):
    ...
    if backend is None:
        ...
        for m in (usbip, libusb1, openusb, libusb0):
